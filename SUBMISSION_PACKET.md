...
- Casper Testnet transaction or deploy hash as the final proof artifact.
...
4. Attach the real Casper Testnet explorer link once funding and transaction submission are complete.
