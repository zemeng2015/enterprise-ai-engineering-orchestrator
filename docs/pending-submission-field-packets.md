...
Status: Profile, Details, and Team are filled. Do not submit until real contact handles are available.

Required user-provided fields:

```text
Telegram username: <required from Zack>
Backup contact: <Discord username OR WhatsApp phone OR WeChat ID required from Zack>
```
