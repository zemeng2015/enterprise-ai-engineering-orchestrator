...
- `Are you an individual or a team participating in UiPath AgentHack?`
  ...
  - Current risk: this was previously observed as `Team`; fix it before final submission if still true.

- `What region are you located in?`
  - Expected: `AMER (Americas) or Canada`

- `What is the UiPath Labs link/environment URL where you built your solution?`
  - Expected: paste the real Labs URL from UiPath's access email.
  - Do not invent a placeholder URL.
...
- Preview the public project page.
